...
import { observableResponse, promiseAsyncResponse, promiseError} from './../../../../testing'
...
describe('ProductsComponent', () => {
  ...
  beforeEach(() => {
    ...
    productService.getAll.and.returnValue(observableResponse(productsMock));
  ...
  describe('Tests for getAllProducts', () => {
    ...
    it('should return change the status "loading" => "success"', fakeAsync(() => {
      // Arrange
      const productsMock = generateManyProducts(10);
      productService.getAll.and.returnValue(promiseAsyncResponse(productsMock));
    ...
    it('should return change the status "loading" => "error"', fakeAsync(() => {
      // Arrange
      productService.getAll.and.returnValue(promiseError('error'));
